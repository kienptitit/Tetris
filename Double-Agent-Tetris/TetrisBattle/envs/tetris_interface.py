...
class TetrisInterface(abc.ABC):
    ...
    def get_seen_grid(self, mode="single"):
        ...
        grid_1 = self.tetris_list[now_player]["tetris"].get_grid()  # 20,17
...
class TetrisSingleInterface(TetrisInterface):
    ...
    def reward_func(self, infos):
        ...
        if infos['is_fallen']:
            ...
            additional_reward = -0.51 * infos['height_sum'] + 0.76 * infos['cleared'] - 0.36 * infos['holes'] - 0.18 * \
                                infos['diff_sum']
    ...
    def act(self, action):
        ...
        if tetris.check_fallen():
            ...
            if tetris.check_KO():
                ...
                # scores -= 5
                penalty_die = self.total_reward * 0.5
